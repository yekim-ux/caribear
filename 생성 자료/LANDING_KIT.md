...
│  ├─ js/
│  │  └─ caribear-site.js    컬러 정본·내비 토글·이미지 경로 (59줄)
│  └─ img/
│     ├─ bear-<color>[-angle].webp      큰 컷 620×1100 · ~150KB
│     ├─ sm/bear-<color>[-angle].webp   작은 컷 237×420 · ~40KB
...
빼놓는 게 낫다. 지금은 7군데에 흩어져 있어 무드 교체 때 일일이 찾아야 한다.
...
"C:/Program Files/Blender Foundation/Blender 5.2/blender.exe" -b -P tools/blender_render_bear.py -- \
  ...
  --out assets/img --colors black,red,orange,yellow,green,blue,purple,pink \
